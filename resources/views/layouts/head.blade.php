<head>
	...
	<!-- Superfish -->
	<link rel="stylesheet" href="{{url('template/css/superfish.css')}}">
	<!-- Magnific Popup -->
	<link rel="stylesheet" href="{{url('template/css/magnific-popup.css')}}">
	<!-- Date Picker -->
	<link rel="stylesheet" href="{{url('template/css/bootstrap-datepicker.min.css')}}">
	<!-- CS Select -->
	<link rel="stylesheet" href="{{url('template/css/cs-select.css')}}">
	<link rel="stylesheet" href="{{url('template/css/cs-skin-border.css')}}">
