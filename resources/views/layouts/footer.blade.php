...
<script src="{{url('template/js/magnific-popup-options.js')}}"></script>
<!-- Date Picker -->
<script src="{{url('template/js/bootstrap-datepicker.min.js')}}"></script>
<!-- CS Select -->
<script src="{{url('template/js/classie.js')}}"></script>
<script src="{{url('template/js/selectFx.js')}}"></script>
